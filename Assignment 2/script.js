...
let term1ID = document.getElementById("term1")
let term2ID = document.getElementById("term2")
let term3ID = document.getElementById("term3")

const headID = document.querySelector("h1")
headID.style.color = new THREE.Color("black")
...
const wordFolder = ui.addFolder('Words')
